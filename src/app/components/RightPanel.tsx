...
export function RightPanel() {
  return (
    <div className="h-full flex flex-col gap-2">
      {/* Results */}
      <div className="flex-1 bg-gradient-to-br from-teal-800/70 to-blue-800/70 rounded-xl p-3 border-l-4 border-teal-400 shadow-md backdrop-blur-sm">
        <div className="flex items-center gap-2 mb-2">
          <BarChart3 className="w-5 h-5 text-teal-300 shrink-0" />
        ...
        {/* T-Test Bar Chart */}
        <div className="bg-slate-900/50 rounded-lg p-3 mb-2 border border-teal-500/30">
          <div className="h-32 bg-gradient-to-t from-slate-900 to-slate-800 rounded flex items-end justify-around p-2 gap-2">
            {/* AI Conception */}
          ...
          <p className="text-[8px] text-center text-teal-200 mt-1">Figure 1: Top vs. Bottom Quartile (n = 695, all p &lt; 0.0001)</p>
        </div>
        
        {/* Main Finding */}
        <div className="text-xs text-teal-100 mb-2">
          <p><span className="font-semibold text-white">Main Finding:</span> Welch's t-tests confirmed statistically significant differences between top- and bottom-quartile cows on all four metrics (p &lt; 0.0001).</p>
        </div>
        
        {/* Results Bullets */}
        <div className="bg-slate-900/30 rounded-lg p-2 border border-teal-500/20 space-y-1">
          <p className="text-[11px] text-teal-100"><span className="font-semibold text-white">AI Conception:</span> 83.9% vs. 72.2% — 11.7 pp gap</p>
          <p className="text-[11px] text-teal-100"><span className="font-semibold text-white">Calf Survival:</span> 99.8% vs. 94.3% — 5.5 pp gap</p>
          <p className="text-[11px] text-teal-100"><span className="font-semibold text-white">Birth Weight:</span> 75.6 vs. 71.5 lbs — 4.1 lb gap</p>
          <p className="text-[11px] text-teal-100"><span className="font-semibold text-white">Calving Interval:</span> 369 vs. 395 days — 25.4 day gap</p>
          <p className="text-[11px] text-teal-100 pt-1 border-t border-teal-500/20"><span className="font-semibold text-white">AI vs. Excel:</span> 5/5 correct in ~3 sec; Excel: 10–45 min, failed 1/5</p>
        </div>
      </div>
      
      {/* Contact */}
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-3 border border-yellow-500/30 shadow-md">
        <div className="flex items-start gap-3">
          <div className="flex-1">
            <h4 className="text-xs font-bold text-white mb-1 border-b border-yellow-500/40 pb-1" style={{
